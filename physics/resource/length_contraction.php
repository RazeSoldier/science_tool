...
/*声明变量*/
$c = 299792458; //光速
$s = $_POST["lcs"]; //用户输入量"物体运动方向的长度"
$v = $_POST["lcv"]; //用户输入量"物体的速度"
...
echo "<title>长度收缩计算结果/学园都市</title>";
echo "<b>条件量</b></br>";
echo "物体运动方向的长度:$s m</br>";
echo "物体的速度:$v m·s<sup>-1</sup></br>";
echo "<hr/>洛伦兹因子:$lorentz_factor</br><b>计算结果</b>:$result m"; //输出结果
}