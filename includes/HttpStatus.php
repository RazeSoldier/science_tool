 ...
 *
 * This file is copied from the Mediawiki project, and on this basis modified.
 * Source File: https://phabricator.wikimedia.org/source/mediawiki/browse/master/includes/libs/HttpStatus.php
 *
 * @file
 */
...
class HttpStatus {
    ...
    public static function header( $code ) {
        ...
        if ( $version === null ) {
            ...
            $_SERVER['SERVER_PROTOCOL'] === 'HTTP1.0' ?
            '1.0' :
            '1.1';
        }
